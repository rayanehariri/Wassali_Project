...
def login():
    ...
    if result["success"]:
        ...
        firebase_token = firebase_auth.create_custom_token(user_id)
        result["firebaseToken"] = firebase_token if isinstance(firebase_token, str) else firebase_token.decode("utf-8")
