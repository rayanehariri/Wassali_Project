  ...
  function handleLogin(user, token) {
    ...
    if (user.role === 'deliverer') {
      ...
      if (user.status === 'active' && !savedWelcomeSeen) {
        finalUser = { ...user, status: 'verified_welcome', welcomeSeen: false };
      } else if (user.status === 'active' && savedWelcomeSeen) {
        // Carry welcomeSeen:true into finalUser so it stays in localStorage
        finalUser = { ...user, welcomeSeen: true };
      }
    ...
    // Admin or client → admin dashboard
